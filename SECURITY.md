...
If you discover a security vulnerability in **az-mapping**, please report it responsibly:

1. **Do not** open a public GitHub issue.
2. Email the maintainer at **security@yourproject.example** or use [GitHub's private vulnerability reporting](https://github.com/lrivallain/az-mapping/security/advisories/new).
